...
type inverseStepNameType =
  ...
  | "Li and Li"
  | "Soleymani";
const m1 = Matrix.random(5, 5, 0.00, 10.0);
const m = Matrix.Hadamard(Matrix.plus(m1, Matrix.transpose(m1)), .5);
// const invm = Matrix.inverse(m);
const PS1 = Matrix.initialInverseApproximationCodevico(m);
