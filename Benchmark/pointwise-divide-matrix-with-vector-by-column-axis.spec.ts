...
(async () => {
  ...
  const pointwiseDivideMatrixWithVectorByColumnAxisInRowMode = (
  ...
  const pointwiseDivideMatrixWithVectorByColumnAxisInColumnMode = (
    m: MatrixType | NumericMatrix,
    v: MatrixType | NumericMatrix,
  ) =>
    numeric.pointwise2(
  ...
  const condition = Matrix.FrobeniusNorm(
        Matrix.minus(
          ...
          pointwiseDivideMatrixWithVectorByColumnAxisInRowMode(r2, v1),
        ),
        ...
        Matrix.minus(
          ...
          pointwiseDivideMatrixWithVectorByColumnAxisInColumnMode(r2, v2),
        ),
      ) <= 1e-8;

  const euriklisTestInRowMode = (m: any) =>
    m.pointwiseDivideMatrixWithVectorByColumnAxis(r1, v1);
  const euriklisTestInColumnMode = (m: any) =>
    m.pointwiseDivideMatrixWithVectorByColumnAxis(
      r1,
      v2,
      undefined,
      "column",
